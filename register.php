...
$pass = password_hash( $user_password,PASSWORD_BCRYPT);
 ...
 $email_check = " SELECT * from `techadmin` where email = ' $user_email'";

$email_verify = mysqli_query($connect,$email_check);
...
if(mysqli_num_rows($email_verify) > 0 ){
   ...
   $query = "INSERT INTO `techadmin` (`Name`, `Email`, `Password`) VALUES ('$user_name', '$user_email', '$user_password')";
}
$query_verify = mysqli_query($connect,$query);
